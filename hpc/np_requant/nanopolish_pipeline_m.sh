...
path_base=`echo "./output/${path_base}/${file_base}"`

file_bam=./${path_base}/minimap2/${file_base}
...
mkdir -p ./${path_base}/minimap2/ ./${path_base}/nanopolish_train/ ./${path_base}/requant ./${path_base}/nanopolish_methcall/
