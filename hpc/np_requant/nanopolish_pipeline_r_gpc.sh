...
file_model_exp=./r9.4_450bps.nucleotide.6mer.expand_gpc.model # Expanded nanopolish model
file_model_dir=${path_np_train}/r9.4_450bps.gpc.6mer.template.round4.model # Model as trained (directly)
...
## Replaced model
# Modified
./nanopolish_GpC call-methylation \
	--threads ${num_threads} \
